...
@Generated(value={}, comments="Generated by me.geso.hana.generator.RowClassGenerator", date="2014-07-11T00:39:01.786Z")
...
public abstract class AbstractMember extends me.geso.hana.AbstractRow {
	 ...
	 */
	public long countBlogs(Connection connection) throws SQLException, HanaException {
		return Select.from(me.geso.hana.row.Blog.class).where(me.geso.hana.Condition.eq("member_id", this.id)).count(connection);
	}
	
	public Stream<me.geso.hana.row.Blog> searchBlogs(Connection connection) throws SQLException, HanaException {
		return Select.from(me.geso.hana.row.Blog.class).where(me.geso.hana.Condition.eq("member_id", this.id)).stream(connection);
	}
