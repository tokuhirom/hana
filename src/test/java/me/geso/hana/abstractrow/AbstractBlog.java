...
@Generated(value={}, comments="Generated by me.geso.hana.generator.RowClassGenerator", date="2014-07-10T02:36:22.628Z")
...
public abstract class AbstractBlog extends me.geso.hana.AbstractRow {
	...
	public long countEntries() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Entry.class).where(me.geso.hana.Condition.eq("blog_id", this.id)).count();
	}
	
	public List<me.geso.hana.row.Entry> searchEntries() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Entry.class).where(me.geso.hana.Condition.eq("blog_id", this.id)).getResultList();
	}
	
	public Optional<me.geso.hana.row.Member> retrieveMember() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Member.class).where(me.geso.hana.Condition.eq("id", this.member_id)).first();
	}
