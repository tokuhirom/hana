...
@Generated(value={}, comments="Generated by me.geso.hana.generator.RowClassGenerator", date="2014-07-08T08:10:58.580Z")
...
public abstract class AbstractEntry extends me.geso.hana.AbstractRow {
	...
	public long countComments() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Comment.class).where("entry_id=?", this.id).count();
	}
	
	public List<me.geso.hana.row.Comment> searchComments() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Comment.class).where("entry_id=?", this.id).getResultList();
	}
	
	public Optional<me.geso.hana.row.Blog> retrieveBlog() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Blog.class).where("id=?", this.blog_id).first();
	}
