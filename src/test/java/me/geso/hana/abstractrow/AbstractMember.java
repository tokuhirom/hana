...
@Generated(value={}, comments="Generated by me.geso.hana.generator.RowClassGenerator", date="2014-07-10T02:36:23.251Z")
...
public abstract class AbstractMember extends me.geso.hana.AbstractRow {
	...
	public long countBlogs() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Blog.class).where(me.geso.hana.Condition.eq("member_id", this.id)).count();
	}
	
	public List<me.geso.hana.row.Blog> searchBlogs() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Blog.class).where(me.geso.hana.Condition.eq("member_id", this.id)).getResultList();
	}
