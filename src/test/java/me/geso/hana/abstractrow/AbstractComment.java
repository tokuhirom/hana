...
@Generated(value={}, comments="Generated by me.geso.hana.generator.RowClassGenerator", date="2014-07-08T08:10:58.567Z")
...
public abstract class AbstractComment extends me.geso.hana.AbstractRow {
	...
	public Optional<me.geso.hana.row.Entry> retrieveEntry() throws SQLException, HanaException {
		return this.currentSession().search(me.geso.hana.row.Entry.class).where("id=?", this.entry_id).first();
	}
